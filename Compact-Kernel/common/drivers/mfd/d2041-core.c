...
#include <linux/d2041/rtc.h>
#include <mach/gpio.h>

#include <linux/proc_fs.h>
#include <linux/kthread.h>

#if defined(CONFIG_BOARD_CORI) || defined(CONFIG_BOARD_AMAZING)|| defined(CONFIG_BOARD_AMAZING_SS)|| defined(CONFIG_BOARD_CORI_DS)
...
int d2041_device_init(struct d2041 *d2041, int irq,
		       struct d2041_platform_data *pdata)
{
	...
	d2041_reg_write(d2041, D2041_BUCKA_REG,0x9A); // change automatic mode to PWM mode only, 20120612                  
...
int d2041_shutdown(struct d2041 *d2041)
{
    ...
    d2041_clear_bits(d2041, D2041_LDO10_REG, (1<<6)); //LDO 10 disable
    d2041_clear_bits(d2041, D2041_LDO11_REG, (1<<6)); //LDO 11 disable
    d2041_clear_bits(d2041, D2041_LDO13_REG, (1<<6)); //LDO 13 disable
    d2041_clear_bits(d2041, D2041_LDO14_REG, (1<<6)); //LDO 14 disable
    d2041_clear_bits(d2041, D2041_LDO15_REG, (1<<6)); //LDO 15 disable
    d2041_clear_bits(d2041, D2041_LDO16_REG, (1<<6)); //LDO 16 disable
    d2041_clear_bits(d2041, D2041_LDO17_REG, (1<<6)); //LDO 17 disable
    d2041_clear_bits(d2041, D2041_LDO18_REG, (1<<6)); //LDO 18 disable
    d2041_clear_bits(d2041, D2041_LDO19_REG, (1<<6)); //LDO 19 disable
    d2041_clear_bits(d2041, D2041_LDO20_REG, (1<<6)); //LDO 20 disable
    d2041_clear_bits(d2041, D2041_LDO_AUD_REG, (1<<6)); //LDO_AUD disable
    ...
    dst=0x0;
    d2041->write_dev(d2041, D2041_LDO10_REG, 1, &dst); //LDO 10

    dst=0x0;
    d2041->write_dev(d2041, D2041_LDO11_REG, 1, &dst); //LDO 11
    
    dst=0x0;
    d2041->write_dev(d2041, D2041_LDO13_REG, 1, &dst); //LDO 13
    
    dst=0x0;
    d2041->write_dev(d2041, D2041_LDO14_REG, 1, &dst); //LDO 14
    
    dst=0x0;
    d2041->write_dev(d2041, D2041_LDO15_REG, 1, &dst); //LDO 15
    
    dst=0x0;
    d2041->write_dev(d2041, D2041_LDO16_REG, 1, &dst); //LDO 16
    
    dst=0x0;
    d2041->write_dev(d2041, D2041_LDO17_REG, 1, &dst); //LDO 17

    dst=0x0;
    d2041->write_dev(d2041, D2041_LDO18_REG, 1, &dst); //LDO 18

    dst=0x0;
    d2041->write_dev(d2041, D2041_LDO19_REG, 1, &dst); //LDO 19

    dst=0x0;
    d2041->write_dev(d2041, D2041_LDO20_REG, 1, &dst); //LDO 20

    dst=0x0;
    d2041->write_dev(d2041, D2041_LDO_AUD_REG, 1, &dst); //AUD_LDO
