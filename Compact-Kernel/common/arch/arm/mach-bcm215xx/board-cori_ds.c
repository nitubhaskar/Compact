...
*
*	@file	arch/arm/mach-bcm215xx/board-cori_ds.c
*
...
#define BATT_LEVEL5_VOLT	3920//3950
#define BATT_LEVEL4_VOLT	3810//3860
#define BATT_LEVEL3_VOLT	3740//3790
#define BATT_LEVEL2_VOLT	3660//3740
#define BATT_LEVEL1_VOLT	3630//3680
...
static int calculate_batt_level(int batt_volt)
{
	...
	{
		if( (prev_scaled_level==1) &&  (pmu_is_charger_inserted==true) && (scaled_level<10) && (scaled_level>1))
			prev_scaled_level++;
		else
			prev_scaled_level = scaled_level;
	}
...
static void cori_ds_init_gpio(void)
{
/* +++ H/W req */
#define ADDR_GPIO_GPIPUD0 (HW_GPIO_BASE + 0x028) //0x088CE028 GPIO 0 - 31
#define ADDR_GPIO_GPIPUD1 (HW_GPIO_BASE + 0x02c) //0x088CE02C GPIO 32 - 63
