...
#define BCM_CORE_CLK_LOWA	BCM21553_CORECLK_KHZ_288
...
static struct bcm_freq_tbl bcm215xx_cpu0_freq_tbl[] = {
	...
	FTBL_INIT(BCM_CORE_CLK_NORMAL / 1000, 11800000),//original=12000000
...
static struct bcm_cpu_info bcm215xx_cpu_info[] = {
	[0] = {
		...
		.cpu_latency = 300000,//CPUFREQ_ETERNAL,
		.cpu_clk = "arm11",
...
static void bcm215xx_avs_notify(int silicon_type)
{
	...
	/* look into my sources fo this :) part/1*/
	if (normal >= 0)
	{
...
static struct bcm_avs_platform_data_t bcm_avs_pdata = {
	...
	/* look into my sources fo this :) part/2*/
	.otp_bit_lsb = 169,
	.otp_bit_msb = 188,
...
{
	/* look into my sources fo this :) part/3*/
