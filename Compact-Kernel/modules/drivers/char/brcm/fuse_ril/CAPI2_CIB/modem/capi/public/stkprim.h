...
typedef enum
{
	...
	C_CMD_REQ_VALUE_MISSING             = REQUIRED_VALUE_MISSING,
...
//******************************************************************************
//
// Function Name:	SendSetupEventListRes
//
// Description:		Send Terminal Response for Setup Event List
//
// Boolean result - TRUE if setup event list is accepted; FALSE otherwise. 
//
//******************************************************************************
void SendSetupEventListRes(Boolean result);
