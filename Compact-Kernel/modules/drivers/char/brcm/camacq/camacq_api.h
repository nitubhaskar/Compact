...
typedef enum eCamacqSensorData_e
{
    ...
    CAMACQ_SENSORDATA_PREVIEW_RETURN,
 
    
    CAMACQ_SENSORDATA_CCD_BRIGHTNESS_0,  // 170
    CAMACQ_SENSORDATA_CCD_BRIGHTNESS_1,    
    CAMACQ_SENSORDATA_CCD_BRIGHTNESS_2,        
    CAMACQ_SENSORDATA_CCD_BRIGHTNESS_3,    
    CAMACQ_SENSORDATA_CCD_BRIGHTNESS_4,    
    CAMACQ_SENSORDATA_CCD_BRIGHTNESS_5,    
    CAMACQ_SENSORDATA_CCD_BRIGHTNESS_6, 
    CAMACQ_SENSORDATA_CCD_BRIGHTNESS_7,
    CAMACQ_SENSORDATA_CCD_BRIGHTNESS_8,

#endif    // CONFIG_BCM_CAM_S5K4ECGX
    CAMACQ_SENSORDATA_DEFAULT_CAL,
    CAMACQ_SENSORDATA_FIXEDFRAME_30,
    CAMACQ_SENSORDATA_FIXEDFRAME_25
...
GLOBAL U32 PreviewRet_Amazing;
GLOBAL U32 Drv_Unlock;
#endif
/* For totoro */
typedef enum 
{
